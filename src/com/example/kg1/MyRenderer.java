...
public class MyRenderer {
	...
	private WireShape createShape() {
		...
		Vertex[] frontSide = new Vertex[8];

		frontSide[0] = new Vertex(0f, 0f, -100f);
		frontSide[1] = new Vertex(100f, 0f, -100f);
		frontSide[2] = new Vertex(100f, 100f, -100f);
		frontSide[3] = new Vertex(0f, 100f, -100f);
		frontSide[4] = new Vertex(0f, 0f, 100f - 100f);
		frontSide[5] = new Vertex(100f, 0f, 100f - 100f);
		frontSide[6] = new Vertex(100f, 100f, 100f - 100f);
		frontSide[7] = new Vertex(0f, 100f, 100f - 100f);
		...
		shape.addEdge(new Edge(frontSide[3], frontSide[0]));
		...
		shape.addEdge(new Edge(frontSide[7], frontSide[4]));

		shape.addEdge(new Edge(frontSide[0], frontSide[4]));
		shape.addEdge(new Edge(frontSide[4], frontSide[7]));
		shape.addEdge(new Edge(frontSide[7], frontSide[3]));
		shape.addEdge(new Edge(frontSide[3], frontSide[0]));

		shape.addEdge(new Edge(frontSide[1], frontSide[5]));
		shape.addEdge(new Edge(frontSide[5], frontSide[6]));
		shape.addEdge(new Edge(frontSide[6], frontSide[2]));
		shape.addEdge(new Edge(frontSide[2], frontSide[1]));
	...
	public void task(float x, float y) {
		translate[3][0] = x;
